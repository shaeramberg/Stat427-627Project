...
It predicted 84.97% of the training data correctly, which is also relatively good. There are 9 nonzero predictors.
...
```{r}
set.seed(627)
randomForest(pass_fail ~ . -G3-five_level-G2-G1, data=portuguese.data, mtry=21, importance=TRUE)->RF21
...
Once again, 21 seems to be displaying better output. Our error rate is 16.76%, but we have a relatively better prediction ability for failing students, 10% improvement.
